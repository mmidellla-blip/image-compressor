    ...
    <SiteChrome mainClassName="legal-main">
      <article>
        ...
        <p>
          ...
          <Link href="/contact">문의 페이지</Link>로 보내 주시면 확인 후 반영합니다. 편집 기준과
          출처 정책은 <Link href="/editorial-policy">편집 기준 페이지</Link>에서 확인할 수
          있습니다.
        </p>

        <h2 className="legal-h2">콘텐츠 신뢰성 및 편집 원칙</h2>
        <p>
          머니깨비 편집팀은 기획재정부, 국세청, 국토교통부, 금융감독원 등 공공기관의 공식 보도자료와 법령 정보를 기초로 콘텐츠를 작성합니다. 복잡한 세무·대출·청약 제도를 일반 사용자의 눈높이에 맞게 각색하되, 데이터의 왜곡이 없도록 시뮬레이션 검증을 거칩니다. 또한 정기적으로 개정 세법과 고시를 모니터링하여 최신 정보를 유지하고 있습니다.
        </p>
