...
export const metadata = buildStaticPageMetadata({
  title: "머니깨비 - 청약 가점·신용점수·연말정산·종부세 계산기 | 경제 용어사전",
  description:
    "청약 가점 계산기, 신용점수 시뮬레이터, 연말정산 환급액 계산기, 종합부동산세 계산기를 무료로 제공합니다. 무주택기간, 뱅크런, 소득공제, 세액공제 같은 경제 용어도 쉽게 찾아볼 수 있습니다.",
  path: "/",
  keywords: [
    "머니깨비",
    "청약 가점 계산기",
    ...
    <SiteChrome mainClassName="home-wrap">
      ...
      <header className="home-hero">
        ...
        <p className="home-lead">
          청약·신용점수·연말정산·종부세처럼 매일 마주치지만 막상 알아보려면 어려운 돈 이야기를,
          계산기와 쉬운 설명으로 바로 확인해 보세요.
        </p>
        <p className="home-problem-lead">
          청약·신용·연말정산·종부세 주제별 아티클과 계산기로, 내 상황에 맞는 숫자와 개념을
          바로 확인해 보세요.
        </p>
