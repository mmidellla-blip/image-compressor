...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    metaTitle: "이미지 배경 제거 — AI 누끼 무료, 브라우저에서 바로",
    metaDescription:
      "이미지를 올리면 AI가 배경을 자동으로 제거해요. 파일이 서버로 전송되지 않고 브라우저에서만 처리됩니다. 결과는 투명 PNG로 다운로드.",
    keywords: [
      "배경 제거",
      "누끼",
      "이미지 배경 지우기",
    ...
    h1: "이미지 배경 제거",
    intro:
      "이미지를 올리면 AI가 배경을 자동으로 분리해 투명 PNG로 저장해줘요. 상품 사진 흰 배경 만들기, SNS 프로필 누끼 따기, 발표 자료 인물 컷 등에 바로 쓸 수 있어요. 모든 처리는 브라우저 안에서만 이뤄지고 파일이 외부 서버로 전송되지 않아요.",
    howToTitle: "사용 방법",
    howToSteps: [
      {
        title: "1. 이미지 업로드",
        body: "JPG, PNG, WebP 등 이미지를 올립니다. 드래그 앤 드롭도 가능해요.",
      },
      {
        title: "2. 배경 제거 시작",
        body: "'배경 제거 시작' 버튼을 누르면 AI 모델이 자동으로 피사체와 배경을 구분해요. 처음 실행 시 모델 다운로드(약 30MB)가 필요해 조금 걸릴 수 있어요.",
      },
      {
        title: "3. PNG 다운로드",
        body: "완성된 투명 배경 이미지를 PNG로 다운로드하세요. 이후 배경색 합성·용량 압축도 이어서 할 수 있어요.",
      },
    ],
    useCasesTitle: "이럴 때 사용하세요",
    useCases: [
      "쇼핑몰 상품 사진을 흰 배경 컷으로 통일하고 싶을 때",
      "SNS·프로필 이미지에서 배경만 깔끔하게 지우고 싶을 때",
      "발표 자료·썸네일에 인물·제품만 따서 붙여넣고 싶을 때",
      "스티커·굿즈 시안 작업 전 배경 분리가 필요할 때",
    ],
    warningsTitle: "사용 전 확인하세요",
    warnings: [
      "AI가 배경과 피사체 경계를 자동 판단하므로, 복잡한 경계나 반투명 소재는 가장자리가 부정확할 수 있어요.",
      "결과물은 투명 배경 PNG로 저장됩니다. JPG는 투명도를 지원하지 않아 PNG만 제공해요.",
      "증명사진·공공 제출용은 기관별 배경 규정을 따르세요. 자동 제거 결과가 기준에 맞지 않을 수 있어요.",
    ],
    faqs: [
      {
        question: "파일이 서버로 올라가나요?",
        answer:
          "아니요. AI 모델이 브라우저 안에서 실행되고, 파일이 외부 서버로 전송되지 않아요. 민감한 이미지도 안심하고 쓸 수 있어요.",
      },
      {
        question: "처음 실행할 때 왜 오래 걸리나요?",
        answer:
          "AI 모델 파일(약 30MB)을 처음 한 번만 다운로드해요. 이후 재실행 시엔 캐시된 모델을 써서 빠르게 처리됩니다.",
      },
      {
        question: "배경 제거 결과가 깔끔하지 않아요.",
        answer:
          "피사체와 배경 색상 대비가 클수록 정확도가 높아요. 복잡한 배경이나 머리카락 끝 등 세밀한 부분은 결과가 다를 수 있어요.",
      },
      {
        question: "배경을 흰색으로 바꾸고 싶어요.",
        answer:
          "이 도구는 배경을 투명하게 만들어요. 흰 배경이 필요하면 PNG 다운로드 후 이미지 편집 툴에서 흰색 레이어를 깔거나, PNG→JPG 변환 시 흰 배경이 자동 적용돼요.",
      },
    ],
    relatedToolSlugs: ["compress", "png-to-webp", "resize", "photo-mosaic"],
    relatedBlogSlugs: [
      "쇼핑몰-상세페이지-이미지-최적화",
      "증명사진-용량-줄이는-방법",
      "webp-변환-필요한-이유",
    ...
    schemaDescription:
      "AI가 브라우저에서 직접 배경을 제거해 투명 PNG로 저장하는 무료 이미지 도구입니다. 파일이 서버로 전송되지 않아 개인정보가 안전합니다.",
    homeGrid: "primary",
  },
];
