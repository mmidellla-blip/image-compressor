...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    path: "/photo-mosaic",
    status: "coming_soon",
    metaTitle: "사진 모자이크 (준비 중) — 개인정보 가리기",
    metaDescription:
      "얼굴·번호판 등을 가리는 모자이크 기능을 준비 중입니다. 배포 전에는 편집 앱으로 가리거나, 공유 범위를 줄이는 방법을 권장합니다.",
    keywords: [
      "모자이크",
      "사진 편집",
      "개인정보",
    ...
    h1: "사진 모자이크",
    intro:
      "커뮤니티·중고 거래·민원 서류 인증 샷에는 타인의 얼굴이나 차량 번호가 들어가기 쉽습니다. 브라우저에서 영역을 지정해 모자이크를 입히는 기능을 설계 중이며, 공개 전까지는 스마트폰 기본 편집기나 PC 프로그램으로 가리는 편이 안전합니다.",
    howToTitle: "준비 중 · 대안",
    howToSteps: [
      {
        title: "1. 공유 전 검토",
        body: "배경에 전화번호·주소·신분증 일부가 보이지 않는지 한 번 더 확인합니다.",
      },
      {
        title: "2. 기기 내 편집",
        body: "아이폰·안드로이드 사진 편집의 마크업/모자이크 기능을 활용합니다.",
      },
      {
        title: "3. 이후 로드맵",
        body: "웹 도구로 간단한 사각형 블러를 제공할 계획입니다.",
      },
    ],
    useCasesTitle: "이럴 때 사용하세요",
    useCases: [
      "중고 거래 인증 사진에 주소·연락처가 보일 때(출시 후)",
      "행사 사진에 참석자 얼굴을 가리고 올리고 싶을 때",
      "민원 서류 예시를 SNS에 올리기 전",
    ],
    warningsTitle: "사용 전 확인하세요",
    warnings: [
      "모자이크 기능은 아직 제공되지 않습니다. 민감 정보가 포함된 이미지는 불필요한 업로드를 피하세요.",
      "원본은 로컬에서만 보관하고, 가공본만 공유하는 습관이 안전합니다.",
    ],
    faqs: [
      {
        question: "왜 아직 안 되나요?",
        answer:
          "Canvas 기반으로 개인정보가 메모리에 남지 않게 처리하는 흐름을 검증 중입니다.",
      },
      {
        question: "지금은 어떻게 하나요?",
        answer:
          "스마트폰 사진 앱의 편집 기능으로 얼굴·텍스트 영역을 가리거나, 아예 해당 부분을 크롭하지 않고 올리지 않는 방법이 있습니다.",
      },
      {
        question: "이미지 용량도 줄이고 싶어요.",
        answer:
          "가린 뒤에는 ‘이미지 용량 줄이기’로 JPG/WebP 맞춤을 이어가면 됩니다.",
      },
    ],
