...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    slug: "preset",
    path: "/preset",
    metaTitle: "이력서·공무원 시험·여권 사진 규격 한 번에 완성",
    metaDescription:
      "회원가입 없이 이력서용·공무원 시험 응시원서용·여권용 사진 규격을 한 번에 맞춥니다. 자르기·리사이즈·배경 흰색 정리·용량 압축을 브라우저에서 한 번에 처리합니다.",
    keywords: [
      "이력서 사진 규격",
      "공무원 시험 응시원서 사진 규격",
      "여권 사진 규격",
    ...
    h1: "이력서·공무원 시험·여권 사진 규격 완성",
    intro:
      "사람인·잡코리아 이력서용, 공무원 시험 응시원서용, 여권용 사진 규격 3종 중 하나를 고르면 자르기·리사이즈·배경 흰색 정리·용량 압축을 한 번에 처리해 드립니다. 사진은 서버로 전송되지 않고 브라우저에서만 처리됩니다.",
    howToTitle: "사용 방법",
    howToSteps: [
      {
        title: "1. 규격 선택",
    ...
    schemaDescription:
      "이력서용·공무원 시험 응시원서용·여권용 사진 규격에 맞춰 자르기·리사이즈·배경 흰색 정리·용량 압축을 한 번에 처리하는 무료 브라우저 도구입니다.",
  },
];
