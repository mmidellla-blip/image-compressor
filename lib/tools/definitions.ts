...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    h1: "GIF 압축",
    intro:
      "움짤(GIF)을 올리면 색상 수·해상도·프레임 수를 조절해 용량을 줄여줘요. 카카오톡·SNS 업로드 용량 제한에 걸릴 때, 블로그에 올릴 GIF가 너무 무거울 때 바로 쓸 수 있어요. 파일은 브라우저 안에서만 처리되고 외부 서버로 전송되지 않아요.",
    howToTitle: "사용 방법",
    howToSteps: [
      {
        title: "1. GIF 업로드",
        body: "GIF 파일을 올립니다. 드래그 앤 드롭도 가능해요.",
      },
      {
        title: "2. 옵션 선택",
        body: "색상 수(32~256), 해상도(50~100%), 프레임 유지 비율을 선택하세요. 색상 수를 줄이는 것이 가장 효과적이에요.",
      },
      {
        title: "3. 압축 · 다운로드",
        body: "’압축 시작’을 누르면 원본 대비 절감 비율과 미리보기가 표시돼요. 확인 후 다운로드하세요.",
      },
    ],
    useCasesTitle: "이럴 때 사용하세요",
    useCases: [
      "카카오톡·메신저에서 움짤 전송 시 용량 초과가 뜰 때",
      "블로그·카페에 올릴 GIF가 너무 무거울 때",
      "SNS 업로드 파일 크기 제한에 걸릴 때",
      "이메일에 GIF를 첨부하기 전 용량을 줄이고 싶을 때",
    ],
    warningsTitle: "사용 전 확인하세요",
    warnings: [
      "색상 수를 32 이하로 줄이면 색 번짐·계단 현상이 생길 수 있어요. 미리보기로 확인하세요.",
      "프레임을 절반으로 줄이면 애니메이션 속도가 2배 빨라 보일 수 있어요. 용량과 자연스러움을 타협해서 조절하세요.",
      "GIF는 PNG·WebP보다 압축 효율이 낮아요. 정지 이미지라면 이미지 용량 줄이기를 쓰는 게 더 나을 수 있어요.",
    ],
    faqs: [
      {
      ...
      {
        question: "색상 수를 줄이면 어떻게 달라지나요?",
        answer:
          "GIF는 최대 256색을 사용해요. 128색으로 줄이면 화질 차이를 거의 느끼기 어렵지만 용량이 크게 줄어요. 32색은 단순한 도형·텍스트 GIF에 적합해요.",
      },
      {
        question: "압축 후 파일이 더 커졌어요.",
        answer:
          "원본이 이미 잘 최적화된 경우거나 색상 수가 적은 GIF라면 더 줄어들지 않을 수 있어요. 해상도를 줄이거나 프레임 수를 조절해 보세요.",
      },
      {
        question: "애니메이션이 깨져 보여요.",
        answer:
          "색상 수를 높이거나 해상도를 원본(100%)으로 맞춰 다시 압축해 보세요. 복잡한 GIF는 128색 이상이 적합해요.",
      },
    ],
    relatedToolSlugs: ["compress", "png-to-webp", "resize", "jpg-to-png"],
    relatedBlogSlugs: ["이미지-압축-방법", "온라인-이미지-압축", "무료-이미지-줄이기-툴"],
    schemaDescription:
      "GIF 파일을 브라우저에서 직접 압축하는 무료 온라인 도구입니다. 색상 수·해상도·프레임 수를 조절해 용량을 줄입니다.",
    homeGrid: "primary",
  },
  {
    slug: "resize",
  ...
  },
  {
    slug: "gif-maker",
    path: "/gif-maker",
    metaTitle: "GIF 만들기 — 이미지 여러 장으로 움짤 무료 제작",
    metaDescription:
      "JPG·PNG 이미지를 올리고 순서·속도를 조절하면 브라우저에서 바로 GIF를 만들어줘요. 서버로 파일이 전송되지 않습니다.",
    keywords: [
      "GIF 만들기",
      "움짤 만들기",
      "이미지 GIF 변환",
    ...
    h1: "GIF 만들기",
    intro:
      "여러 장의 이미지를 올리면 순서를 정해 애니메이션 GIF를 만들 수 있어요. 카드뉴스 움짤, 제품 360도 회전 이미지, 짧은 슬라이드쇼 등에 활용할 수 있어요. 모든 처리는 브라우저 안에서만 이뤄지고 파일이 외부 서버로 전송되지 않아요.",
    howToTitle: "사용 방법",
    howToSteps: [
      {
        title: "1. 이미지 업로드",
        body: "JPG, PNG, WebP 등 이미지를 여러 장 올립니다. 드래그 앤 드롭도 가능해요.",
      },
      {
        title: "2. 순서·속도 조절",
        body: "프레임 순서를 조정하고 재생 속도(프레임 간격)를 설정하세요.",
      },
      {
        title: "3. GIF 다운로드",
        body: "'GIF 만들기' 버튼을 누르면 미리보기가 표시되고, 완성된 GIF를 다운로드할 수 있어요.",
      },
    ],
    useCasesTitle: "이럴 때 사용하세요",
    useCases: [
      "카드뉴스 이미지 여러 장을 하나의 움짤로 만들고 싶을 때",
      "제품 사진을 360도 회전 GIF로 만들어 쇼핑몰에 올리고 싶을 때",
      "여행 사진을 슬라이드쇼 GIF로 만들어 SNS에 공유하고 싶을 때",
      "Before/After 비교 이미지를 반복 재생 GIF로 만들고 싶을 때",
    ],
    warningsTitle: "사용 전 확인하세요",
    warnings: [
      "GIF는 최대 256색이라 사진처럼 색이 많은 이미지는 색 번짐이 생길 수 있어요. 도식·일러스트 이미지에 더 적합합니다.",
      "이미지 크기가 크거나 프레임이 많으면 제작에 시간이 걸릴 수 있어요. 해상도를 줄이면 더 빠르게 처리됩니다.",
      "모든 프레임은 첫 번째 이미지 기준으로 크기가 맞춰져요.",
    ],
    faqs: [
      {
        question: "파일이 서버로 올라가나요?",
        answer: "아니요. 모든 처리는 브라우저 안에서만 이뤄지고, 파일이 외부 서버로 전송되지 않아요.",
      },
      {
        question: "몇 장까지 올릴 수 있나요?",
        answer: "최대 30장까지 업로드할 수 있어요. 프레임이 많을수록 GIF 용량도 커져요.",
      },
      {
        question: "GIF가 너무 무거워요.",
        answer: "해상도를 줄이거나 색상 수를 낮춰 보세요. 만든 GIF를 'GIF 압축' 도구로 추가 압축할 수도 있어요.",
      },
      {
        question: "동영상으로 GIF를 만들 수 있나요?",
        answer: "현재는 이미지 파일만 지원해요. 동영상에서 프레임을 추출한 뒤 이 도구에 올리면 돼요.",
      },
    ],
    relatedToolSlugs: ["gif-compress", "compress", "resize", "png-to-webp"],
    relatedBlogSlugs: ["이미지-압축-방법", "온라인-이미지-압축", "무료-이미지-줄이기-툴"],
    schemaDescription:
  ...
  },
  {
    slug: "preset",
    path: "/preset",
    metaTitle: "증명사진 규격 완성 - 여권·이력서·공무원 시험 (300x400~413x531px)",
    metaDescription:
      "회원가입 없이 증명사진 규격을 한 번에 맞춥니다. 이력서용 300x400px, 공무원 시험 응시원서용 350x450px, 여권용 413x531px 등 규격별 자르기·리사이즈·배경 흰색 정리·용량 압축을 브라우저에서 처리합니다.",
    keywords: [
      "증명사진 규격",
      "증명사진 용량 줄이기",
      "이력서 사진 규격",
    ...
    h1: "증명사진 규격 완성 (여권·이력서·공무원 시험)",
    intro:
      "증명사진이 필요한 상황(이력서용 300x400px, 공무원 시험 응시원서용 350x450px, 여권용 413x531px)에 맞춰 규격 3종 중 하나를 고르면 자르기·리사이즈·배경 흰색 정리·용량 압축을 한 번에 처리해 드립니다. 사진은 서버로 전송되지 않고 브라우저에서만 처리됩니다.",
    howToTitle: "사용 방법",
    howToSteps: [
      {
        title: "1. 규격 선택",
        body: "이력서용·공무원 시험 응시원서용·여권용 중 필요한 규격을 고릅니다.",
      },
      {
        title: "2. 사진 업로드",
        body: "정면 사진 파일을 선택합니다.",
      },
      {
        title: "3. 자르기 조정",
        body: "비율이 고정된 상태로 드래그·확대해 원하는 위치로 맞춥니다.",
      },
      {
        title: "4. 완성하기",
        body: "자르기 → 리사이즈 → (선택 시) 배경 흰색 정리 → 용량 압축이 순서대로 진행되고, 완료되면 바로 다운로드할 수 있습니다.",
      },
    ],
    useCasesTitle: "이럴 때 사용하세요",
    useCases: [
      "사람인·잡코리아 등에 이력서 사진을 올리기 전",
      "공무원 시험 응시원서 접수 화면에 사진을 첨부하기 전",
      "여권 재발급·신규 발급 신청 전",
      "사진관에 가지 않고 집에서 규격 사진을 급하게 만들어야 할 때",
    ],
    warningsTitle: "사용 전 확인하세요",
    warnings: [
      "이 도구가 제시하는 픽셀·용량 수치는 참고용입니다. 실제 접수처 공고문의 규격을 반드시 다시 확인하세요.",
      "배경 흰색 정리는 AI가 자동으로 경계를 판단하므로, 복잡한 배경이나 반투명 소재에서는 결과가 부정확할 수 있습니다. 결과 미리보기를 꼭 확인하세요.",
      "목표 용량이 매우 작으면 화질이 크게 낮아질 수 있어, 화질 저하가 심한 경우 확인 절차를 거칩니다.",
      "AI 배경 정리는 처음 실행 시 약 30MB 모델을 다운로드해 시간이 걸릴 수 있습니다. 저사양 기기·느린 네트워크에서는 더 오래 걸릴 수 있습니다.",
      "원본 사진은 별도로 보관하고, 완성된 파일만 제출용으로 사용하세요.",
    ],
    faqs: [
      {
        question: "서버에 사진이 저장되나요?",
        answer:
          "아니요. 자르기·리사이즈·배경 정리·압축 모두 브라우저 안에서만 처리되며, 서버로 전송되거나 저장되지 않습니다.",
      },
      {
        question: "이 규격이 접수처 기준과 다르면 어떻게 하나요?",
        answer:
          "이 도구의 수치는 일반적으로 널리 쓰이는 기준을 참고한 값입니다. 접수처 공고문에 별도 규격이 있다면 그 기준을 우선하고, 필요하면 '이미지 크기 조절'·'이미지 용량 줄이기' 도구로 추가 조정하세요.",
      },
      {
        question: "배경을 꼭 흰색으로 바꿔야 하나요?",
        answer:
          "아니요. 기본값은 켜져 있지만 토글을 꺼서 원본 배경을 그대로 유지할 수 있습니다. 배경 정리 결과가 이상하면 미리보기 단계에서 '건너뛰기'를 선택하세요.",
      },
      {
        question: "자르기 비율을 자유롭게 바꿀 수 있나요?",
        answer:
          "아니요. 선택한 규격의 비율로 고정되어 위치와 확대만 조정할 수 있습니다. 다른 비율이 필요하면 '이미지 크기 조절' 도구를 이용하세요.",
      },
    ],
    relatedToolSlugs: ["passport-photo", "resize", "background-remove", "compress"],
    relatedBlogSlugs: [
      "증명사진-용량-줄이기-여권-이력서-공무원시험-규격-총정리",
      "증명사진-300x400-픽셀-비율-맞추는법",
      "취업사진-용량-줄이는법",
      "여권사진-규격-집에서-딱-맞게-만드는법",
      "공무원-시험-응시원서-사진-350x450-규격-맞추는법",
    ],
    relatedArticlesTitle: "규격 기준 자세히 보기",
    schemaDescription:
      "증명사진 규격(이력서용·공무원 시험 응시원서용·여권용)에 맞춰 자르기·리사이즈·배경 흰색 정리·용량 압축을 한 번에 처리하는 무료 브라우저 도구입니다.",
  },
];
